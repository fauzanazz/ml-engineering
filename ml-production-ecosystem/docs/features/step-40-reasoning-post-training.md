...
- `src/ml_production_ecosystem/reasoning_post_training/` for SFT, verifier rewards, GRPO-style updates, self-play, evaluation, backend boundaries, CLI.
...
- `docs/domains/reasoning-post-training/reasoning-post-training.md` for algorithm, system, evaluation, failure-mode, and scaling notes.
