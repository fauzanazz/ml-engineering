...
export class NetBot {
     ...
     */
    best_move(state: any, sims: number): any;
    /**
...
export interface InitOutput {
    ...
    readonly __wbg_netbot_free: (a: number, b: number) => void;
    ...
    readonly netbot_best_move: (a: number, b: any, c: number) => [number, number, number];
    readonly netbot_new: (a: number, b: number) => [number, number, number];
