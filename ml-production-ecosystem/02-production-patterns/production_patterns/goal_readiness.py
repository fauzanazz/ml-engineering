...
CHECKS = (
    ...
    },
    {
        ...
        "evidence": ("02-production-patterns/production_patterns/canary_decision.py", "tests/test_canary_decision.py", "scripts/smoke-local-deployment.sh"),
    ...
    },
    {
        ...
        "evidence": ("02-production-patterns/production_patterns/canary_router.py", "tests/test_canary_router.py", "02-production-patterns/docs/release-checklist.md", "pyproject.toml"),
    ...
    },
    {
        ...
        "evidence": ("03-scale-and-reliability/scale_reliability/slo_burn_rate.py", "tests/test_slo_burn_rate.py", "03-scale-and-reliability/docs/slo-definition.md"),
    ...
    },
    {
        ...
        "evidence": ("03-scale-and-reliability/scale_reliability/burn_rate_alert.py", "tests/test_burn_rate_alert.py", "03-scale-and-reliability/docs/burn-rate-alerting.md"),
    ...
    },
    {
        ...
        "evidence": ("03-scale-and-reliability/scale_reliability/autoscaling_decision.py", "tests/test_autoscaling_decision.py", "03-scale-and-reliability/docs/autoscaling-simulation.md"),
    ...
    },
    {
        ...
        "evidence": ("03-scale-and-reliability/scale_reliability/load_aggregate.py", "tests/test_load_aggregate.py", "03-scale-and-reliability/docs/distributed-load-aggregation.md"),
    ...
    },
    {
        ...
        "evidence": ("03-scale-and-reliability/scale_reliability/cost_estimate.py", "tests/test_cost_estimate.py", "03-scale-and-reliability/docs/cost-estimation.md"),
    ...
    },
    {
        ...
        "evidence": ("04-platform-and-cloud/iac/local/kubernetes/foundation-api.yaml", "02-production-patterns/production_patterns/local_kubernetes.py", "tests/test_local_kubernetes.py", "pyproject.toml"),
    ...
    },
    {
        ...
        "evidence": ("04-platform-and-cloud/iac/local/scheduler/jobs.yaml", "02-production-patterns/production_patterns/local_scheduler.py", "tests/test_local_scheduler.py", "pyproject.toml"),
