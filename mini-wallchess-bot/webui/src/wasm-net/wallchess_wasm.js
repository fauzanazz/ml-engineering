/* @ts-self-types="./wallchess_wasm.d.ts" */
...
export class NetBot {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        NetBotFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_netbot_free(ptr, 0);
    }
    /**
     ...
     * @returns {any}
     */
    best_move(state, sims) {
        const ret = wasm.netbot_best_move(this.__wbg_ptr, state, sims);
        if (ret[2]) {
    ...
    constructor(weights) {
        ...
        const ret = wasm.netbot_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        NetBotFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) NetBot.prototype[Symbol.dispose] = NetBot.prototype.free;
 ...
 * @returns {any}
 */
export function analyze_state(state, depth, k) {
    const ret = wasm.analyze_state(state, depth, k);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function generate_graph_js(state, rank_depth, k, margin, win_k, max_depth, max_nodes) {
    const ret = wasm.generate_graph_js(state, rank_depth, k, margin, win_k, max_depth, max_nodes);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function top_moves_js(state, depth, k, margin, win_k) {
    const ret = wasm.top_moves_js(state, depth, k, margin, win_k);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wallchess_wasm_bg.js": import0,
    };
}

const NetBotFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_netbot_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wallchess_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
