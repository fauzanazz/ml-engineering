...
1. Keep `01-foundation` runnable locally with no cloud dependency.
2. Use `02-production-patterns` for lifecycle workflows: batch, monitoring, retraining, rollback, release summary.
3. Use `03-scale-and-reliability` for local reliability simulations before platform work.
