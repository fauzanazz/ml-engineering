...
- local model registry at `01-foundation/registry/models.json`.
- local artifact storage under `01-foundation/artifacts`.
...
- Add cost and scaling comparison after load testing exists in `03-million-scale`.
