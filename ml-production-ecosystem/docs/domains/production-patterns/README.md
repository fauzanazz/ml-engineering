...
Step 11 batch inference is treated as transition work: implementation still lives in `src/ml_production_ecosystem/recommendation/batch.py`, but conceptually belongs here as a production pattern.
