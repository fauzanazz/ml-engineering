...
| Registry metadata | `registry/models.json` | medium | controlled activation/rollback path |
...
- scheduled retraining report: `artifacts/reports/production-patterns/scheduled-retraining.json`
- rollback report: `artifacts/reports/production-patterns/rollback.json`
