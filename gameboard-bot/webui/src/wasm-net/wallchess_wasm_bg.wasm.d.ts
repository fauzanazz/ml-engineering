...
export const __wbg_netbot_free: (a: number, b: number) => void;
...
export const netbot_best_move: (a: number, b: any, c: number) => [number, number, number];
export const netbot_new: (a: number, b: number) => [number, number, number];
